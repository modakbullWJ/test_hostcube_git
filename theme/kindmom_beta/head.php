    ...
    <div class="inner">
        <div class="service">
            <ul>
                ...
                <li class="mintsale"><a href="" target="_blank">SHOP착한엄마</a></li>
               <!-- <li class="mintblog"><a href="http://blog.mimint.co.kr" target="_blank">mint blog</a></li>-->
                <li class="mpic"><a href="" target="_blank">YO</a></li>
                <!--<li class="mfun"><a href="http://www.mimint.co.kr/mdown/">M&middot;fun</a></li>-->
            </ul>
        </div>
        <div class="util">
          <ul>

                <li class="logout"><a href=""><span>로그인</span></a></li>

                <li class="toon"><a href=""><span>1:1문의</span></a></li>
                <li class="bg"><a href=""><span>고고고</span></a></li>
